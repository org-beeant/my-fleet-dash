...
import { FHHistory } from "./definitions";

export const FHHistoryColumns: ColumnDef<FHHistory>[] = [
  {
    accessorKey: "SL #",
    header: "SL #",
    cell: ({ row }) => (
  ...
  {
    accessorKey: "Total Transactions Found",
    header: "Total No. of Transactions Found",
    cell: ({ row }) => (
      <div className="capitalize text-xs">
        {row.getValue("Total Transactions Found")}
      </div>
    ),
  },
  /* {
